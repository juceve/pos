<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('responsable', $proveedore->responsable, ['class' => 'form-control' . ($errors->has('responsable') ? ' is-invalid' : ''), 'placeholder' => 'Responsable']) }}
            {!! $errors->first('responsable', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('telefonoResponsable') }}
            {{ Form::text('telefonoResponsable', $proveedore->telefonoResponsable, ['class' => 'form-control' . ($errors->has('telefonoResponsable') ? ' is-invalid' : ''), 'placeholder' => 'Telefonoresponsable']) }}
            {!! $errors->first('telefonoResponsable', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('activo') }}
        ...
        <div class="form-group">
            {{ Form::label('provcategoria_id') }}
            {{ Form::text('provcategoria_id', $proveedore->provcategoria_id, ['class' => 'form-control' . ($errors->has('provcategoria_id') ? ' is-invalid' : ''), 'placeholder' => 'Provcategoria Id']) }}
            {!! $errors->first('provcategoria_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
