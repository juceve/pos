<div class="box box-info padding-1">
    <div class="col-12 col-lg-6 box-body">

        <div class="form-group">
            <div class="form-group">
                {{ Form::label('Fecha') }}
                {{ Form::date('fecha', $prodlote->fecha, ['class' => 'form-control' . ($errors->has('fecha') ? ' is-invalid' : ''), 'placeholder' => '']) }}
        ...
        <div class="form-group">
            ...
            {!! Form::select('producto_id', $productos, $prodlote->producto_id, ['class' => 'Select2' , 'style' => 'width: 100%',
